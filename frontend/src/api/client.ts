...
export const apiClient = {
  ...
  // Failover configuration APIs
  getFailoverConfig: () => request<ApiResponse>('/api/admin/failover', { method: 'GET' }),

  saveFailoverConfig: (config: unknown) =>
    request('/api/admin/failover', {
      method: 'POST',
      body: JSON.stringify(config),
    }),
