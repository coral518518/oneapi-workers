...
import {
    FailoverGetEndpoint, FailoverUpdateEndpoint
} from "./failover_api"
...
// Failover configuration routes
api.get("/api/admin/failover", FailoverGetEndpoint)
api.post("/api/admin/failover", FailoverUpdateEndpoint)
